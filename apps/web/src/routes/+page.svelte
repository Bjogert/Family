<script lang="ts">
  ...
  // My assigned tasks (for current user) - active tasks that need action
  ...
  // Tasks I created that are awaiting my approval (status=done and requiresValidation)
...
>
  <div class="h-full flex flex-col lg:flex-row gap-6 p-4 lg:p-6 max-w-7xl mx-auto">
    ...
    <div class="flex-1 min-w-0 space-y-3">
      ...
      <!-- My Tasks Section - Show if user has assigned tasks or tasks awaiting approval -->
